...
import org.ares.cloud.merchantInfo.repository.MerchantSubSpecificationRepository;
...
import org.ares.cloud.merchantInfo.vo.MerchantSubSpecificationVo;
    ...
    public void deleteById(String id) {
        ...
        if (merchantSubSpecificationEntity != null){
            ...
            if (merchantSpecificationDto != null){
                //主规格未删除异常
                throw new RequestBadException(MerchantError.MERCHANT_SUB_SPECIFICATION_IS_NOT_DELETE_ERROR);
            }
            //删除前判断商品是否已下架
            ...
            if ("deleted".equals(result)) {
                ...
                //商品未下架异常
                throw new RequestBadException(MerchantError.PRODUCT_IS_ENABLE_ERROR);
            }
        }
    }
