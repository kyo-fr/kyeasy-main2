...
* @date 2024-10-16
*/
public interface PlatformWorkOrderService extends BaseService<PlatformWorkOrderEntity> {
    /**
    * 将数据保存到仓库中.
    * @param dto  数据对象
    */
    void create(PlatformWorkOrderDto dto);

    /**
    * 将数据保存到仓库中.
    * @param dos 数据对象集合
    */
    void create(List<PlatformWorkOrderDto> dos);

    /**
    * 更新仓库数据.
    * @param dto 数据对象集合
    */
    void update(PlatformWorkOrderDto dto);

    /**
    * 更新仓库数据.
    * @param dos 数据对象集合
    */
    void update(List<PlatformWorkOrderDto> dos);
    ...
    * @return entity
    */
    PlatformWorkOrderDto loadById(String id);
    ...
    * @return 集合是实体
    */
    List<PlatformWorkOrderDto> loadByIds(List<String> ids);
    ...
    */
    List<PlatformWorkOrderDto> loadAll();
    ...
    * @return list of entities.
    */
    PageResult<PlatformWorkOrderVo> loadList(PlatformWorkOrderQuery query);
}