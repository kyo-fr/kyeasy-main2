...
* @description 平台信息 服务接口
* @version 1.0.0
* @date 2024-10-15
*/
public interface PlatformInfoService extends BaseService<PlatformInfoEntity> {
    /**
    * 将数据保存到仓库中.
    * @param dto  数据对象
    */
    void create(PlatformInfoDto dto);

    /**
    * 将数据保存到仓库中.
    * @param dos 数据对象集合
    */
    void create(List<PlatformInfoDto> dos);
    ...
    * @param dos 数据对象集合
    */
    void update(List<PlatformInfoDto> dos);
    ...
    * @return entity
    */
    PlatformInfoDto loadById(String id);
    ...
    * @return 集合是实体
    */
    List<PlatformInfoDto> loadByIds(List<String> ids);
    ...
    * @return list of entities.
    */
    PageResult<PlatformInfoDto> loadList(PlatformInfoQuery query);

    PlatformInfoDto getInfoByUserId();
