...
* @description 硬件管理 服务接口
* @version 1.0.0
* @date 2024-10-12
*/
public interface HardWareService extends BaseService<HardWareEntity> {
    /**
    * 将数据保存到仓库中.
    * @param dto  数据对象
    */
    ...
    * @param dos 数据对象集合
    */
    void create(List<HardWareDto> dos);

    /**
    * 更新仓库数据.
    * @param dto 数据对象集合
    */
    void update(HardWareDto dto);

    /**
    * 更新仓库数据.
    * @param dos 数据对象集合
    */
    void update(List<HardWareDto> dos);
    ...
    * @return entity
    */
    HardWareDto loadById(String id);
    ...
    * @return 集合是实体
    */
    List<HardWareDto> loadByIds(List<String> ids);
    ...
    * @return list of entities.
    */
    PageResult<HardWareDto> loadList(HardWareQuery query);
}