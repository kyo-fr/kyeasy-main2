...
import org.ares.cloud.product.convert.MerchantMarkingConvert;
...
import org.ares.cloud.product.repository.MerchantMarkingRepository;
    ...
    */
    ...
    public void create(MerchantMarkingDto dto) {
        ...
        if (merchantMarkingEntity == null){
            ...
            throw new RequestBadException(ProductError.MERCHANT_MARKING_NAME_EXIST_ERROR);
        }
    }
    ...
    */
    private Wrapper<MerchantMarkingEntity> getWrapper(MerchantMarkingQuery query){
        ...
        if (StringUtils.isNotEmpty(query.getTenantId())){
            wrapper.eq(MerchantMarkingEntity::getTenantId, query.getTenantId());
        }
        return wrapper;
    }
}