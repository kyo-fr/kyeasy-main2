...
import org.ares.cloud.annotations.OperateLog;
import org.ares.cloud.common.constant.interfaces.Constant;
import org.ares.cloud.common.context.ApplicationContext;
import org.ares.cloud.common.utils.AddressUtils;
import org.ares.cloud.common.utils.HttpContextUtils;
import org.ares.cloud.common.utils.IpUtils;
...
public class OperateLogAspect {
    private final DefOperateLogService operateLogService;

    public OperateLogAspect(DefOperateLogService operateLogService) {
    ...
    private void saveLog(ProceedingJoinPoint joinPoint, OperateLog operateLog, LocalDateTime startTime, Integer status) {
        ...
        // 用户信息
        log.setUserId(ApplicationContext.getUserId());
        log.setTenantId(ApplicationContext.getTenantId());
        // 操作类型
    ...
    private String obtainMethodArgs(ProceedingJoinPoint joinPoint) {
        ...
        if (argNames != null){
            ...
            for (int i = 0; i < argValues.length; i++) {
                Object argValue = argValues[i];
                args.put("args"+i, ignoreArgs(argValue) ? "[ignore]" : argValue);
            }
        }
